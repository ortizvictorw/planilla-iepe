...
const SabadoListSegunda = () => {
  ...
  const getReservas = async () => {
    await db
      .collection("Reservas-sabado-segunda")
  ...
  return (
    <div className="container">
      ...
      <BootstrapTable id="s2" keyField="id" data={usuarios} columns={columns} />
      ...
      {isPastor ? (
        <ReactHTMLTableToExcel
          ...
          table="s2"
          filename="sabado-segunda-reunion"
          sheet="tablexls"
...
export default SabadoListSegunda;
