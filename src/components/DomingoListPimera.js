...
const DomingoListPrimera = () => {
  ...
  const getReservas = async () => {
    await db
      .collection("Reservas-domingo-primera")
  ...
  return (
    <div className="container">
      ...
      <BootstrapTable id="d1" keyField="id" data={usuarios} columns={columns} />
      ...
      {isPastor ? (
        <ReactHTMLTableToExcel
          ...
          table="d1"
          filename="domingo-primera-reunion"
          sheet="tablexls"
...
export default DomingoListPrimera;
